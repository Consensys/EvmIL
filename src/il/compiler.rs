...
impl Compiler {
    ...
    pub fn to_bytecode(self) -> StructuredContract<Instruction> {
        // NOTE: since the assembly generated is generated by this
        // compiler, we can assume it is well formed.
        self.to_assembly().assemble().unwrap()
    }
...
/// with an error.
impl TryFrom<&[Term]> for StructuredContract<Instruction> {
...
/// Translate a sequence of IL statements into EVM bytecode, or fail
/// with an error.
impl<const N: usize> TryFrom<&[Term; N]> for StructuredContract<Instruction> {
...
fn try_from(terms: &[Term]) -> std::result::Result<StructuredContract<Instruction>, CompilerError> {
