...
impl Compiler {
    ...
    pub fn to_bytecode(self) -> Contract<Instruction> {
...
/// with an error.
impl TryFrom<&[Term]> for Contract<Instruction> {
...
/// Translate a sequence of IL statements into EVM bytecode, or fail
/// with an error.
impl<const N: usize> TryFrom<&[Term; N]> for Contract<Instruction> {
...
fn try_from(terms: &[Term]) -> std::result::Result<Contract<Instruction>, CompilerError> {
